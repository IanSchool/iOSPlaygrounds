...
var favoriteBook = Book(title: "Boook", author: "The Man", pages: 100, price: 0.99)
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.title) with \(favoriteBook.pages) pages, it costs $\(favoriteBook.price)")
...
struct Height {
    ...
    var heightInCenimeters = Double()
    
    init(heightInInches: Double){
        self.heightInInches = heightInInches
        heightInCenimeters = heightInInches * 2.54
    }
    init(heightInCentimeters: Double){
        self.heightInCenimeters = heightInCentimeters
...
print(someonesHeight.heightInCenimeters)
...
print(myHeight.heightInCenimeters)
