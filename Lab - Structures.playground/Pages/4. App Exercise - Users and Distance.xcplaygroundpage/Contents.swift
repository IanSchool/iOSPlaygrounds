...
var ian = User(name: "ian", age: 17, weight: 160, height: 76, activityLevel: 7)
print(ian.name)
print(ian.age)
print(ian.weight)
print(ian.height)
print(ian.activityLevel)
...
var myHouseToSchool = Distance(feet: 325)
print(myHouseToSchool.meters)
