...
let favariteFood = printFavorite(categoryOfThing: "food", favorite: "hotdogs")
...
let favoriteGame = printFavorite(categoryOfThing: "game", favorite: "tag")
print (favoriteGame)

let favoritePerson = printFavorite(categoryOfThing: "person", favorite: "me")
print (favoriteGame)
...
print("Hello, my name is ian. \(favoriteGame) \(favoritePerson)")
