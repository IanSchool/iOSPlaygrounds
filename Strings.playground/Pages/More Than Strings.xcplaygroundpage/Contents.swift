...
let noun = "tree"
let place = "store"
let positiveEmotion = "bliss"
let negativeEmotion = "distraught"
let storySetence = "Today was a big day for \(name). They had finally saved up \(number) dollars and were going to buy a \(adjective) \(noun). They went to the \(noun) \(place) feeling very \(positiveEmotion). But they felt \(negativeEmotion). They were all out of \(noun)!"
